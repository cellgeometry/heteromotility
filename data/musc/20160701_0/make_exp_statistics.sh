...
head -n1 ${well}/motility_statistics_xy01.csv > fgf2_exp_motility_statistics.csv
...
head -n1 ${well}/motility_statistics_xy01.csv > nofgf2_exp_motility_statistics.csv
