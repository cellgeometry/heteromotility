...
project = 'Heteromotility'
copyright = '2018, Jacob C. Kimmel'
...
htmlhelp_basename = 'Heteromotilitydoc'
...
latex_documents = [
    (master_doc, 'Heteromotility.tex', 'Heteromotility Documentation',
     'Jacob C. Kimmel', 'manual'),
]
